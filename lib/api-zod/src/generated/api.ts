...
export const GetCustomerResponse = zod.object({
  ...
  "bongaBalance": zod.number().optional(),
 ...
 */
export const GetCustomerBongaParams = zod.object({
  "id": zod.uuid()
})

export const GetCustomerBongaResponse = zod.object({
  "id": zod.uuid(),
  "balance": zod.number(),
...
export const GetInvoicePaymentsResponseItem = zod.object({
  ...
  "amount": zod.string(),
  "method": zod.enum(['MPESA', 'WALLET', 'BONGA', 'CASH']),
